...
int test1(intersectionfunction f, bool testwriteback) {
	...
	const uint32_t firstpost[13] = { 27181, 35350, 39241, 39277, 39278, 44682,
			64706, 120447, 120450, 159274, 159290, 173895, 173942, };
	const uint32_t secondpost[13] = { 25369, 28789, 28790, 28792, 28794, 28797,
			37750, 42317, 68797, 68877, 68881, 68990, 85488 };
